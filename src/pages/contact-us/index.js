...
export default function ContactUs() {
    ...
    return (
        <div className='pb-10'>
            <h1 className='text-center text-3xl font-medium mb-10'>Jika ada masalah pada website ini atau anda ingin berdiskusi, memberikan saran, <br/>dan memperoleh informasi tambahan, segera hubungi kami di bawah ini.</h1>
            <div className='flex items-center gap-10 justify-between'>
                <div className='w-[700px] bg-white shadow-lg rounded-lg px-9 py-4'>
                    <h1 className='font-bold text-xl mb-2 '>Lokasi Server:</h1>
                    <div className='shadow-lg mb-3 border rounded-xl'>
                        <LeafletMap />
                    </div>
                </div>
                <div className='p-4 rounded-lg border bg-white w-[800px] shadow-xl space-y-4 '>
                    <div>
